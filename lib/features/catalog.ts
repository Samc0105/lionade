...
export const FEATURE_CATALOG: FeatureNode[] = [
  ...
  { key: "dashboard.subject_stats", label: "Subject mastery", parentKey: "dashboard" },
  { key: "dashboard.leaderboard_preview", label: "Weekly leaderboard preview", parentKey: "dashboard" },
  { key: "dashboard.recent_quizzes", label: "Recent quizzes", parentKey: "dashboard" },
  { key: "dashboard.level_progress", label: "Level progress", parentKey: "dashboard" },
  { key: "dashboard.circular_stats", label: "Stat chips", parentKey: "dashboard" },

  { key: "learn", label: "Learn hub", parentKey: null },
  { key: "learn.daily_goal", label: "Daily goal", parentKey: "learn" },
  { key: "learn.study_heatmap", label: "Study heatmap", parentKey: "learn" },
  { key: "learn.subject_mastery", label: "Subject mastery", parentKey: "learn" },
  { key: "learn.vocab", label: "Vocabulary", parentKey: "learn" },
  ...
  { key: "social.squad_goal", label: "Squad goal", parentKey: "social" },
  { key: "social.activity_feed", label: "Activity feed", parentKey: "social" },
  { key: "social.friend_list", label: "Friends list", parentKey: "social" },
  { key: "social.chat_thread", label: "Direct messages", parentKey: "social" },
  { key: "social.notifications", label: "Notifications", parentKey: "social" },
  { key: "social.lobbies", label: "Past lobbies", parentKey: "social" },
  ...
  { key: "shop.featured", label: "Featured", parentKey: "shop" },
  { key: "shop.cosmetics", label: "Cosmetics", parentKey: "shop" },
  { key: "shop.boosters", label: "Boosters", parentKey: "shop" },
  { key: "shop.inventory", label: "Inventory", parentKey: "shop" },
  { key: "shop.premium_cosmetics", label: "Premium cosmetics", parentKey: "shop" },
  { key: "shop.founder_badges", label: "Founder badges", parentKey: "shop" },
