...
function buildAuthUser(profile: {
  ...
  return {
    ...
    avatar: profile.avatar_url ?? `https://api.dicebear.com/7.x/avataaars/svg?seed=${profile.username}&backgroundColor=4A90D9&scale=80&translateY=6`,
...
function buildBasicUser(userId: string, email: string, metadata: Record<string, unknown>): AuthUser {
  ...
  return {
    ...
    avatar: `https://api.dicebear.com/7.x/avataaars/svg?seed=${username}&backgroundColor=4A90D9&scale=80&translateY=6`,
    coins: 0,
    streak: 0,
    xp: 0,
    level: 1,
