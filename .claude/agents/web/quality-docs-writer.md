...
description: Documentation writer. Keeps docs/CLAUDE_AGENT.md, LIONADE_CONTEXT.md, FEATURES.md, CHANGELOG.md, and migration READMEs up to date. Writes changelog entries after every feature ships.
...
|------|-----------------|----------------|
| `docs/CLAUDE_AGENT.md` | Standing instructions for Claude agents (non-negotiables, patterns, do-not-touch list) | When patterns change or new rules are added |
