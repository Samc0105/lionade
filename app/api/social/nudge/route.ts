...
export async function POST(req: NextRequest) {
  ...
  try {
    ...
    // Fire a notification to the recipient (best-effort). Routed through the
    // central notifyUser helper, which gates on the dedicated `nudge_received`
    // pref (no longer piggybacking on friend_requests) AND quiet hours.
