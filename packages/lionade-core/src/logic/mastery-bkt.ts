/**
 * Mastery Mode — BKT (Bayesian Knowledge Tracing) math.
 *
 ...
 *
 * Pure functions, no platform deps. Imported by both web and iOS.
 * Moved from web /lib/mastery.ts on 2026-05-13.
 *
...
// Re-export Difficulty so callers can `import { Difficulty, updateBKT } from '@lionade/core/logic/mastery-bkt'`
// without having to know it actually lives in /types.
